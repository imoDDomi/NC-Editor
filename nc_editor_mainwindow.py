...
class Ui_Hauptfenster(object):
    def setupUi(self, Hauptfenster):
        ...
        self.gridLayout_2.addWidget(self.textbrowser, 4, 0, 1, 9)
...
"")
        ...
        self.gridLayout_2.addWidget(self.pb_save, 0, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lb_version, 3, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pb_save_as, 0, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lb_saved, 1, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lb_saved_text, 1, 7, 1, 1)

        self.horizontalSpacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer, 1, 3, 1, 4)

        self.horizontalSpacer_4 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_4, 0, 3, 1, 4)

        self.horizontalSpacer_3 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_3, 3, 3, 1, 5)
